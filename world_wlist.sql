...
CREATE TABLE `wlist` (
  ...
  `wlist` varchar(1000) DEFAULT NULL,
...
INSERT INTO `wlist` VALUES (1,'AAPL,AMD,INTU,QCOM,AAPL,AAPL','banana'),(6,'AMD,AMAT,AVGO,AAPL,ASML','apple'),(61,'AAPL,AVGO','s@gmail.com'),(62,'NVDA,AVGO','s123@gmail.com');
